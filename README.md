...
3. **Rubrics:** Review job-specific criteria or choose **Create grade ladder** from a job to prepare separate GS levels. Inspect the selected sources and grade matrix before approving supported versions. Weights must total 100.
