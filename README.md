...
Theme preference uses `score-theme`. Recent workspace IDs and view state are local convenience data only; private documents, counts, searches, and saved evidence remain server-owned.
