...
| Rubric AI assistant | `RUBRIC_ASSISTANT_ENABLED` (API only; provisioned `false`) | No stores; requires real jobs and the `RUBRIC_MODEL_*` settings; reuses the `jobRubric` binding; advertised as `rubricAssistant` |
