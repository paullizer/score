...
test('settings and access infrastructure isolate runtime permission writes from four settings readers and the renderer', () => {
  ...
  assert.match(resources, /SCORE_ACCESS_CONTAINER: accessContainer\.name/)
  assert.match(resources, /SCORE_ENTRA_SERVICE_PRINCIPAL_ID: authServicePrincipalId/)
  ...
  assert.doesNotMatch(renderer, /SCORE_SETTINGS_CONTAINER|settingsReadAccess|SCORE_ACCESS_CONTAINER|applicationAccess/)
